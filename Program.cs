...
class Program
{
    static void Main(string[] args)
    {
        ...
        Qualis q1 = new Qualis("Diesel", 7, "UP-04-GS-5700", IVehicle.Renttype.KM, 7, 5, new DateOnly(2021, 09, 25));
        Qualis q2 = new Qualis("CNG", 4, "MH-01-HI-0210", IVehicle.Renttype.KM, 15, 14, new DateOnly(2022, 02, 28));

        MercedesBenz mb2 = new MercedesBenz("Petrol", 7, "GJ- 01-AB-7875", IVehicle.Renttype.KM, 3, 17, new DateOnly(2022, 02, 12));
